  ...
  return (
      <div className='movie-item'>
        <div className='card-inner'>
            ...
            <Button className="add-watchlist" variant="primary" onClick={handleWatchlist}>{watchlist.find((m) => m.id === data.id) ? <i className="fa-solid fa-check"></i> : <i className="fa-sharp fa-solid fa-plus"></i>} Remove </Button>
